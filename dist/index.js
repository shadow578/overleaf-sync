...
const OverleafClient_1 = __importDefault(__nccwpck_require__(2771));
/**
 * run the workflow
 *
...
function run(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const overleaf = new OverleafClient_1.default(args.auth.host);
        yield overleaf.login(args.auth.email, args.auth.password);
        (0, core_1.debug)(`logged in to ${args.auth.host} with user ${args.auth.email}`);
...
function createWriteStreamAndDir(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        yield fsp.mkdir(path_1.default.dirname(filePath), {
            recursive: true
        });
...
const CookieParser = __importStar(__nccwpck_require__(7303));
/**
 * base class for overleaf client, handles core functionality
 */
class OverleafBaseClient {
    /**
    ...
    getCSRFToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios_1.default.get(this.getUrl("/dev/csrf"), {
    ...
    updateSessionId(response) {
        ...
        const s = (_a = CookieParser.parse(response.headers["set-cookie"], { decodeValues: false })
            .find(c => c.name == "sharelatex.sid")) === null || _a === void 0 ? void 0 : _a.value;
...
exports.default = OverleafBaseClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const axios_1 = __importDefault(__nccwpck_require__(1441));
const HTMLParser = __importStar(__nccwpck_require__(4363));
const BaseClient_1 = __importDefault(__nccwpck_require__(8043));
/**
 * a client for interacting with Overleaf community edition
 */
class OverleafClient extends BaseClient_1.default {
    //#region auth
    /**
    ...
    login(email, password) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const initialResponse = yield axios_1.default.get(this.getUrl("/login"));
            this.updateSessionId(initialResponse);
            this.requireSession();
            // get a csrf token
            //const csrf = await this.getCSRFToken();
            const csrf = (_a = HTMLParser.parse(initialResponse.data)
                .querySelector(`meta[name="ol-csrfToken"]`)) === null || _a === void 0 ? void 0 : _a.getAttribute("content");
            // authentificate with username and password
            const loginResponse = yield axios_1.default.post(this.getUrl("/login"), {
                email: email,
                password: password,
                "_csrf": csrf
            }, {
                headers: Object.assign(Object.assign({}, this.sessionHeaders), { "x-csrf-token": csrf })
            });
            // update the session
    ...
    */
    logout() {
        return __awaiter(this, void 0, void 0, function* () {
            this.requireSession();
            // get a csrf token
            const csrf = yield this.getCSRFToken();
            // do logout
            yield axios_1.default.post(this.getUrl("/logout"), {
                "_csrf": csrf
            }, {
                headers: Object.assign(Object.assign({}, this.sessionHeaders), { "x-csrf-token": csrf })
            });
    ...
    getInvites() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios_1.default.get(this.getUrl("/project"), {
                headers: this.sessionHeaders
            });
            this.updateSessionId(response);
            // get and parse notifications data
            const notificationsJson = (_a = HTMLParser.parse(response.data)
                .querySelector(`meta[name="ol-notifications"]`)) === null || _a === void 0 ? void 0 : _a.getAttribute("content");
    ...
    */
    acceptInvite(invite) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const csrf = yield this.getCSRFToken();
            // query the projects overview page
            const response = yield axios_1.default.post(this.getUrl(`/project/${invite.projectId}/invite/token/${invite.token}/accept`), {}, {
                headers: Object.assign(Object.assign({}, this.sessionHeaders), { "x-csrf-token": csrf })
            });
            this.updateSessionId(response);
        });
    ...
    */
    downloadProject(project) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios_1.default.get(this.getUrl(`/project/${project.id}/download/zip`), {
                headers: this.sessionHeaders,
                responseType: "stream"
            });
            this.updateSessionId(response);
...
exports.default = OverleafClient;
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!force_download && fs.existsSync(".lastrun")) {
            ...
            const lastRunRaw = yield fsp.readFile(".lastrun", "utf8");
...
// Modules
const util = __nccwpck_require__(1669),
	eventsIntercept = __nccwpck_require__(7086);
...
// Modules
const yauzlOriginal = __nccwpck_require__(8781),
	cloner = __nccwpck_require__(6082);

// Imports
const NativePromise = __nccwpck_require__(7600),
	promisify = __nccwpck_require__(9907);
...
// Modules
const cloner = __nccwpck_require__(6082);
